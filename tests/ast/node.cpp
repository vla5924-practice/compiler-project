...
TEST(SyntaxTree, can_construct_integer_literal_value) {
    long value = 1l;
    Node node(value);
...
TEST(SyntaxTree, can_construct_fp_literal_value) {
    float value = 1.0f;
    Node node(value);
...
TEST(SyntaxTree, can_construct_variable_name) {
...
TEST(SyntaxTree, can_construct_type_id) {
    size_t type_id = 1;
    Node node(type_id);
...
TEST(SyntaxTree, can_construct_binary_operation) {
...
TEST(SyntaxTree, can_construct_unary_operation) {
