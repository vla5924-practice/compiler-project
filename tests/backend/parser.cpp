...
TEST(Parser, can_parse_long_expression) {
    ...
    Node::Ptr chic1 = std::make_shared<Node>(NodeType::Expression, chi);
    chi->children.push_back(chic);
    chi1->children.push_back(chic1);
    Node::Ptr ch1 = std::make_shared<Node>(NodeType::BinaryOperation, chic1);
    ch1->value = BinaryOperation::Div;
    chic1->children.push_back(ch1);
    Node::Ptr c1 = std::make_shared<Node>(NodeType::Expression, ch1);
    Node::Ptr c2 = std::make_shared<Node>(2l, ch1);
    ch1->children.push_back(c1);
    ch1->children.push_back(c2);
    Node::Ptr _child1 = std::make_shared<Node>(NodeType::BinaryOperation, c1);
    _child1->value = BinaryOperation::Add;
    c1->children.push_back(_child1);
    Node::Ptr _chil1 = std::make_shared<Node>(NodeType::VariableName, "y", _child1);
    Node::Ptr _chil2 = std::make_shared<Node>(NodeType::Expression, _child1);
    ch1->children.push_back(c1);
    ch1->children.push_back(c2);
    Node::Ptr _chi1 = std::make_shared<Node>(NodeType::BinaryOperation, _chil2);
    _chi1->value = BinaryOperation::Add;
    _chil2->children.push_back(_chi1);
    Node::Ptr _ch1 = std::make_shared<Node>(NodeType::VariableName, "z", _chi1);
    Node::Ptr _ch2 = std::make_shared<Node>(NodeType::Expression, _chi1);
    _chi1->children.push_back(_ch1);
    _chi1->children.push_back(_ch2);
    Node::Ptr _c1 = std::make_shared<Node>(NodeType::BinaryOperation, _ch2);
    _c1->value = BinaryOperation::Mult;
    _ch2->children.push_back(_c1);
    Node::Ptr _chica1 = std::make_shared<Node>(5l, _c1);
    Node::Ptr _chica2 = std::make_shared<Node>(2l, _c1);
    _c1->children.push_back(_chica1);
    _c1->children.push_back(_chica2);
    ASSERT_EQ(tree1, tree);
}
